  ...
  const generateAndShare = async () => {
    ...
    try {
      ...
      if (saved?.id) {
        ...
        Alert.alert(
          'Sent to front desk',
          'The sick note has been generated and is ready for the admin to print and stamp.',
        );
      } else {
        ...
        >
          ...
          {webDocId && (
            <TouchableOpacity
              style={s.webLinkBtn}
              onPress={() => {
                Share.share({ message: `Print this sick note: ${API_BASE}/document.html?id=${webDocId}` });
              }}
            >
